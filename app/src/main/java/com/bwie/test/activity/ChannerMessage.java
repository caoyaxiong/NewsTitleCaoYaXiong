...
import com.bwie.test.adapter.DragAdapter;
import com.bwie.test.adapter.OtherAdapter;
import com.bwie.test.view.DragGridView;
import com.bwie.test.view.MyGridView;
 ...
 * 1. 类的用途
 * 2. @author dell
 * 3. @date 2017/2/24 09:57
 */

public class ChannerMessage extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.channer);
        initView();
    }
